  ...
  def create
    ...
    respond_to do |format|
      if @product_comment.save
        format.html { redirect_to @product_comment.product, notice: 'Product comment was successfully created.' }
        format.json { render :show, status: :created, location: @product_comment.product }
      else
